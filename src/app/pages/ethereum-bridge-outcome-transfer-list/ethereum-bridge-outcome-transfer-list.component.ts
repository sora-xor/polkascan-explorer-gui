...
import {EthereumBridgeOutcomeTransferService} from '../../services/ethereum-bridge-outcome-transfer.service';
import {Subscription} from 'rxjs';
import {AppConfigService} from '../../services/app-config.service';
import {ActivatedRoute} from '@angular/router';

@Component({
  selector: 'ethereum-bridge-outcome-transfer-list',
  templateUrl: './ethereum-bridge-outcome-transfer-list.component.html',
  styleUrls: ['./ethereum-bridge-outcome-transfer-list.component.scss']
})
export class EthereumBridgeOutcomeTransferListComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private ethereumBridgeTransferService: EthereumBridgeOutcomeTransferService,
